    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label for="hopital_name">Name of Hospital / Rescue Unit:</label>
                <input type="text" class="form-control" name="hopital_name" placeholder="ex: St. Lukes" value="{{ old('hopital_name', optional($rmfinformation ?? '')->hopital_name) }}">
            </div>
        ...
        <form action="{{ url('/store_rmfinformation') }}" method="post">
            @csrf 
