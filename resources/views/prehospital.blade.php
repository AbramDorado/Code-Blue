...
<div class="fixed-header">
    ...
    <a id="initialResuscitationBtn" class="btn btn-secondary disabled" >Level of Consciousness</a>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="team" value="{{ old('team', optional($responders ?? '')->team) }}">
                        </div>

                        <div class="form-group">
                            <label for="plate_num">Vehicle Plate No:</label>
                            <input type="text" class="form-control" name="plate_num" value="{{ old('plate_num', optional($responders ?? '')->plate_num) }}">
                        </div>

                        <div class="form-group">
                            <label for="driver">Driver:</label>
                            <input type="text" class="form-control" name="driver" value="{{ old('driver', optional($responders ?? '')->driver) }}">
                        </div>

                        <div class="form-group">
                            <label for="reporter">Reporter:</label>
                            <input type="text" class="form-control" name="reporter" value="{{ old('reporter', optional($responders ?? '')->reporter) }}">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="cameraman" value="{{ old('cameraman', optional($responders ?? '')->cameraman) }}">
                        </div>

                        <div class="form-group">
                            <label for="team_leader">Team Leader:</label>
                            <input type="text" class="form-control" name="team_leader" value="{{ old('team_leader', optional($responders ?? '')->team_leader) }}">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="crew1" placeholder="Crew1" value="{{ old('crew1', optional($responders ?? '')->crew1) }}">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="crew2" placeholder="Crew2" value="{{ old('crew2', optional($responders ?? '')->crew2) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="crew3" placeholder="Crew3" value="{{ old('crew3', optional($responders ?? '')->crew3) }}">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="crew4" placeholder="Crew4" value="{{ old('crew4', optional($responders ?? '')->crew4) }}">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" name="departure_base_time" value="{{ old('departure_base_time', optional($responders ?? '')->departure_base_time ? (\Carbon\Carbon::parse($responders['departure_base_time'])->format('H:i')) : '') }}">
                        </div>

                        <div class="form-group">
                            <label for="arrival_scene_time">Time of Arrival at the Scene:</label>
                            <input type="time" class="form-control" name="arrival_scene_time" value="{{ old('arrival_scene_time', optional($responders ?? '')->arrival_scene_time ? (\Carbon\Carbon::parse($responders['arrival_scene_time'])->format('H:i')) : '') }}">
                        </div>

                        <div class="form-group">
                            <label for="arrival_hospital_time">Time of Arrival at the Hospital:</label>
                            <input type="time" class="form-control" name="arrival_hospital_time" value="{{ old('arrival_hospital_time', optional($responders ?? '')->arrival_hospital_time ? (\Carbon\Carbon::parse($responders['arrival_hospital_time'])->format('H:i')) : '') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">  
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" name="departure_hospital_time" value="{{ old('departure_hospital_time', optional($responders ?? '')->departure_hospital_time ? (\Carbon\Carbon::parse($responders['departure_hospital_time'])->format('H:i')) : '') }}">
                        </div>

                        <div class="form-group">
                            <label for="arrival_base_time">Time of Arrival at the base:</label>
                            <input type="time" class="form-control" name="arrival_base_time" value="{{ old('arrival_base_time', optional($responders ?? '')->arrival_base_time ? (\Carbon\Carbon::parse($responders['arrival_base_time'])->format('H:i')) : '') }}">
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" class="form-control" name="incident_dt" value="{{ old('incident_dt', optional($incident ?? '')->incident_dt ? (\Carbon\Carbon::parse($responders['incident_dt'])->format('Y-m-d H:i:s')) : '') }}">
                </div>

                <div class="form-group">
                    <label for="location">Location:</label>
                    <input type="text" class="form-control" name="location" value="{{ old('location', optional($incident ?? '')->location) }}">
                </div>
